...
Набор: `ArrowDown`, `ArrowRight`, `ArrowUp`, `Branch`, `Check`, `Clock`, `Close`, `Code`, `Download`,
`File`, `Folder`, `Gear`, `Hammer`, `Info`, `Lock`, `Moon`, `More`, `Monitor`, `Package`, `Pause`,
`Pencil`, `Play`, `Plus`, `Refresh`, `Rocket`, `Search`, `Server`, `Stop`, `Sun`, `Terminal`, `Trash`,
`Warning`.
...
- **Знак программы** (`chrome::app_mark`) — квадрат акцента со значком программы, скругление —
  четверть стороны. В шапке он 28, в «О программе» — 56.
